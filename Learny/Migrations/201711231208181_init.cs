namespace Learny.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ModuleActivities", "CourseModuleId", "dbo.CourseModules");
            DropForeignKey("dbo.ModuleActivities", "ActivityTypeId", "dbo.ActivityTypes");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.ModuleActivities", new[] { "ActivityTypeId" });
            DropIndex("dbo.ModuleActivities", new[] { "CourseModuleId" });
            ...
            DropTable("dbo.ModuleActivities");
